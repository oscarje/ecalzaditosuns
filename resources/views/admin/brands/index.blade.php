...
<div class="container mx-auto p-6">
    <h1 class="text-2xl font-semibold mb-6">Gestión de Marcas</h1>

    <a href="{{ route('admin.brands.create') }}" style="
        ...
        <tbody>
            @foreach ($brands as $brand)
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2">{{ $brand->brand_description }}</td>
                            <td class="px-4 py-2 flex space-x-2">
                                <a href="{{ route('admin.brands.edit', $brand->id_brand) }}" style="
                    background-color: #3182ce; /* Azul similar al bg-blue-600 */
                    color: white;
                    padding: 10px 20px;
                    font-size: 14px;
